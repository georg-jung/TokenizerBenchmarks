...
public ref struct PreTokenizingEnumeratorNoAggrInlining
{
    ...
    public PreTokenizingEnumeratorNoAggrInlining(string input, bool convertToLowercase, NormalizationForm vocabNf, int inputOffset = 0)
    {
    ...
    public PreTokenizingEnumeratorNoAggrInlining GetEnumerator() => this;
